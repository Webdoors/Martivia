...
?>
				...
				<th><a class="btn btn-outline-primary" href="https://4seasonsgeorgia.ge/ge/journal/<?=$r2["year"]?>/<?=$r2["id"]?>">ნახვა</a></th>
				<th><a class="btn btn-outline-success" href="https://4seasonsgeorgia.ge/admin?page=seojournal&id=<?=$r2["id"]?>">seo</a></th>
